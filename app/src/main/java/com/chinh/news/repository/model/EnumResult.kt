...
sealed class ApiResult <out T> (val status: ApiStatus,
                                val data: T?,
                                val message:String?,
                                val exceptionObject :Exception? = null) {
    ...
    data class Error(val exception: String,val _exceptionObject :Exception): ApiResult<Nothing>(
